...
void showHelp(){
    ...
    cout << "|        -> patches:                                                   |" << endl;
    cout << "|              . Dimensions:                                           |" << endl;
    cout << "|                -> (Input file) (Tesselation)                         |" << endl;
    cout << "|                                                                      |" << endl;
    cout << "|              . Description:                                          |" << endl;
...
Vertex* makePatch(int tesselation, string inputFile){
    ...
    if(file.is_open()){
        ...
        vx->bezierPatchTriangles(tesselation,patchList);
        return vx;
    }
}
...
int main(int argc, char** argv){
    ...
    if(!strcmp(argv[1], "plane")){
        ...
        vx = makePatch(tess,nameFile);
        saveFile(vx->getPointsList(),vx->getNormalsList(), vx->getTexturesList(), argv[4]);
    }
