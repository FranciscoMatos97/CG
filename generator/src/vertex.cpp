...
float Vertex::getBezierPointTangent(float u, float v, float m[4][4] , float p[4][4], int derivada) {
    float pointValue = 0;
    float aux[4], aux2[4];
...
vector<Point*> Vertex::bezierTangent(int tessellation,vector<Patch*> patch_list){
